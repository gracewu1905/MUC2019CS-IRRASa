...
--
-- Table structure for table `baseinformation`
--

DROP TABLE IF EXISTS `baseinformation`;
...
--
-- Dumping data for table `baseinformation`
--

LOCK TABLES `baseinformation` WRITE;
/*!40000 ALTER TABLE `baseinformation` DISABLE KEYS */;
/*!40000 ALTER TABLE `baseinformation` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-11-05 20:54:32
